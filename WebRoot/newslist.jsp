...
<body leftMargin=0 topMargin=0>
	...
	<div class="main">
		<div class="title">新闻中心&gt;&gt;新闻管理&gt;&gt;新闻管理</div>
		<form name="form1" method="post" action="news/Newsdels">
			<table width="1052" border=0 align=center cellpadding=2 cellspacing=1
				bordercolor="#799AE1" class=tableBorder>
				<tbody>
					<tr>
						<th align=center colspan=16 style="height: 23px">新闻管理</th>
					</tr>
					<tr bgcolor="#DEE5FA">
					...
					<tr align="center" bgcolor="#799AE1">
						...
						<td align="center" class=txlHeaderBackgroundAlternate>文章标题</td>
						<td width="9%" align="center" class=txlHeaderBackgroundAlternate>所属于栏目</td>
						<td width="9%" align="center" class=txlHeaderBackgroundAlternate>创建者</td>
						<td width="23%" class=txlHeaderBackgroundAlternate>创建时间</td>
					...
					<s:iterator value="newss" status="st">
						<tr bgcolor="#DEE5FA">
							<td align="center" class="txlrow">${st.count }</td>
							<td align=center class=txlrow>${newsTitle }</td>
							<td align=center class=txlrow>${category }</td>
							<td width="8%" align=center class=txlrow>${creator }</td>
							<td align=center bgcolor="#DEE5FA" class=txlrow>${createDate
								}</td>
							<td width="8%" align=center class=txlrow>${updater }</td>
							<td align=center class=txlrow>${updateDate }</td>
							<td align=center class=txlrow><a
								href="news/Newsget?id=${news_Id}" title="查看/修改栏目"><img
									class="img_modify" src="images/modify1.gif" /> </a> <a
								href="news/Newsdel?id=${news_Id}" title="删除该栏目"><img
									class="img_modify" src="images/delete.gif" /> </a></td>
							<td align=center class=txlrow><input type="checkbox"
								name="selectid" value="${news_Id}">
							</td>
						</tr>
					</s:iterator>
					<tr bgcolor="#DEE5FA">
						<td colspan="16" align=right bgcolor="#DEE5FA" class=txlrow>
							...
							type="submit" name="ok" value="删除" class="but">
						</td>
					</tr>
					<tr bgcolor="#DEE5FA">
						<td colspan=16 align=center class=txlrow></td>
