...
<body>
	...
	<div class="main">
		...
		<form name="addUserForm" method="post" action="categ/Categadd.do">
			<div class="main_input">
				<table>
					<tr>
						<th align=center colspan=16 style="height: 23px">添加栏目</th>
					</tr>
					<tr bgcolor="#DEE5FA">
					...
					<tr>
						...
						<td width="31%"><input type="text" name="categ.categName"
					...
					<tr>
						...
						<td width="31%"><textarea rows="10" cols="140"
								name="categ.categContent"></textarea><span> *</span>
						</td>
					</tr>
